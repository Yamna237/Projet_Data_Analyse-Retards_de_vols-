...
4. Visualisations avancées :
   ...
   - Scatterplots (distance vs temps de vols...)
5. Analyse de corrélations :
   - Relation entre distance et retards
   - Relation entre la distance de vol et temps de vol
...
- Colonnes principales : flight_date, airline, origin, destination, distance, dep_delay, arr_delay, scheduled_time, actual_time
📝 Auteur
----------
